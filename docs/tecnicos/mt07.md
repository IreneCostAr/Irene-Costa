...
Así se visualizan en mi telégono
...
>>Ultizo el cable violeta al medio, conectado al GPIO 35, ya que no tengo 34. En los extremos dejo 3.3v y GND.
...
Este código crea un servidor web simple:
...
void handleRoot() {
  ...
  html += "<body>. <h1> Valor del Potenciometro</h1>";
  html += "<h2>" + String(valor) + "</h2>";
